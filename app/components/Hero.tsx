  ...
  return (
    <div className="bg-[#e0e1dd] py-10">
      <div className="w-[89%] m-auto grid lg:grid-cols-2 grid-cols-1 items-center max-w-[1400px] gap-20">
        <div>
          <h1 className="text-5xl font-bold text-[#1b263b]">"Sow the Seeds of Literacy, Watch Her Life Blossom!"</h1>
          <p className="mt-5 text-[#778da9] ">
            With every purchase of our lamp merchandise 10% of the sale will go to donation. We love to give back to the
            community
          </p>
